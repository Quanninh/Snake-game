...
//extern int g_snake_head_x;
//extern int g_snake_head_y; // The coordinate of the head snake

//extern int g_snake_direction; // Choose the direction of movement
...
extern size_t g_name_len;  // Length of the player's name
extern const char *g_name; // Player's name
